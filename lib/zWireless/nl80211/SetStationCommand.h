...
#ifndef __NL80211_SETSTATIONCOMMAND_H__
#define __NL80211_SETSTATIONCOMMAND_H__
...
public:
  ...
  SetStationCommand(const unsigned int ifindex_);
...
#endif /* __NL80211_SETSTATIONCOMMAND_H__ */
