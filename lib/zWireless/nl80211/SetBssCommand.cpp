...
#include <zutils/nl80211/SetBssCommand.h>
...
int
SetBssCommand::valid_cb(struct nl_msg* msg_, void* arg_)
{
...
int
SetBssCommand::err_cb(struct sockaddr_nl* nla, struct nlmsgerr* nlerr, void* arg)
{
  ZLOG_ERR("Error executing SetBssCommand");
